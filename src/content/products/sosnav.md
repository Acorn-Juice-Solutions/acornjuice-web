...
<!--
  Pending manual actions before flipping to `status: "available"`:
    ...
    - Confirm the description/features wording reflects the current version
    - Provide product icon at /public/assets/products/sosnav.png
    - Provide at least 1-2 screenshots
-->

SOSNav is a small public-service utility maintained by Acorn Juice. It
answers a boring, important question quickly: *which pharmacy is open
right now?*
